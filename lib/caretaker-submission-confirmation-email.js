...
import { croydonLogoEmailHeaderHtml, getAppBaseUrlFromEnv } from '@/lib/logo-branding'
...
export function buildCaretakerInspectionViewUrl(inspectionId, baseUrl = getAppBaseUrlFromEnv()) {
...
export async function sendCaretakerSubmissionConfirmationEmail({
  ...
  const baseUrl = getAppBaseUrlFromEnv()
