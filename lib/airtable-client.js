...
async function fetchAirtableRecords(tableName, options = {}) {
  if (!AIRTABLE_BASE_ID || !AIRTABLE_API_KEY) {
    ...
    console.warn('AIRTABLE_API_KEY/AIRTABLE_API_TOKEN:', AIRTABLE_API_KEY ? 'Set' : 'Missing')
...
export async function testAirtableConnection() {
  try {
    ...
    console.log('[Airtable Test] API key/token:', AIRTABLE_API_KEY ? 'Set (hidden)' : 'Missing')
