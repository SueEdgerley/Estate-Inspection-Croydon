...
export async function getTemplates() {
  try {
    const response = await fetch('/api/airtable/templates', {
      cache: 'no-store',
    })
...
export async function getTemplateSections(templateId) {
  try {
    const response = await fetch(`/api/airtable/templates/${templateId}/sections`, {
      cache: 'no-store',
    })
...
export async function getSectionQuestions(sectionId) {
  try {
    const response = await fetch(`/api/airtable/sections/${sectionId}/questions`, {
      cache: 'no-store',
    })
...
export async function getPeople() {
  try {
    const response = await fetch('/api/airtable/people', {
      cache: 'no-store',
    })
