  ...
  return {
    ...
    sections: [
      ...
      },
      {
        ...
        sort_order: 4,
        questions: [q('ew_os_comments', 'Comments', 'long_text', { is_required: false })],
      },
      {
        ...
        questions: [
          q(
            'ew_it_roof_access',
            'Is the roof access secure? (Croydon NV Grading – Final)',
            'graded',
            {
              grading_options: ['A', 'B', 'C', 'D', 'NA'],
              grading_scheme_name: 'Croydon NV Grading – Final',
      ...
      },
      {
        ...
        questions: [
          q(
            ...
            'Please can you provide the date of the inspection completed today.',
            'text'
          ),
        ],
      },
