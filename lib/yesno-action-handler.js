...
export async function handleNoAnswer({
  ...
  try {
    ...
    const existingResponse = await fetch(`/api/actions?inspection_id=${inspectionId}&question_id=${questionId}`, { credentials: 'include' })
...
export async function handleYesAnswer(inspectionId, questionId) {
  try {
    ...
    const response = await fetch(`/api/actions?inspection_id=${inspectionId}&question_id=${questionId}`, { credentials: 'include' })
