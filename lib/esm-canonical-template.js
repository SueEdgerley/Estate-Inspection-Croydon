...
const ESM_SECTIONS = [
  ...
  },
  {
    ...
    questions: [
      { text: 'Is there an abandoned vehicle to report?', kind: 'yes_no' },
      { text: 'I hereby give authorisation to AVS for the removal of the following vehicle(s): (Colour, Make / Model, Registration)', kind: 'long_text' },
      { text: 'Location (exact location, door number, access codes)', kind: 'long_text' },
      { text: 'Cost Code', kind: 'single_select' },
      { text: 'Authorising officer details, including email address and phone number', kind: 'long_text' },
    ],
  },
  {
    title: '5. Garages',
