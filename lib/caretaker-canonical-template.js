 ...
 *
 * Every section: (1) Condition — grade A–D–NA, comment + photo always shown; (2) Issue — Yes/No/NA,
 * on Yes → comment, photo, recipient. Section 2 adds vehicle/location/cost/officer/confirm after that pair.
 */
...
function buildAbandonedVehiclesSection() {
  ...
  return {
    ...
    sort_order: 2,
    help_text:
      'Same condition and issue pattern as other sections, then vehicle details, location, cost code, and officer.',
    is_repeatable: false,
    section_type: 'standard',
    questions: [
      gradedConditionRow(secKey),
