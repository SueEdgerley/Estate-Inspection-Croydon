...
const SECTION_DEFINITIONS = [
  {
    ...
    questions: [
      { text: 'Entrance', kind: 'issue_yes_no' },
      { text: 'Lobby', kind: 'issue_yes_no' },
      { text: 'Doors', kind: 'issue_yes_no' },
      { text: 'Glass', kind: 'issue_yes_no' },
      { text: 'Skirting Boards', kind: 'issue_yes_no' },
      { text: 'Ledges and Window Sills', kind: 'issue_yes_no' },
      { text: 'Lights', kind: 'issue_yes_no' },
      { text: 'Lifts', kind: 'issue_yes_no' },
      { text: 'Handrails and Spindles', kind: 'issue_yes_no' },
      { text: 'Cobwebs', kind: 'issue_yes_no' },
      { text: 'Landings', kind: 'issue_yes_no' },
      { text: 'Refuse Chutes/Bin Chambers', kind: 'issue_yes_no' },
