 ...
 * and any other legacy sections in favour of the six sections below.
 */
...
function ynQ(id, questionText, sortOrder) {
  return {
    id,
    question_key: id,
    question_text: questionText,
...
export function buildGroundsMaintenanceTemplate(preserveAirtableId = null) {
  return {
    ...
    sections: [
      ...
      {
        id: 'gm_sec_5_play_seating',
        title: 'Section 5: Play Areas and Seating Areas',
        name: 'Section 5: Play Areas and Seating Areas',
        sort_order: 5,
        help_text: '',
        questions: [
          ynQ(
            'gm_s5_q1',
            'Please confirm whether play areas and seating areas meet the required standard',
            1
          ),
        ],
      },
      {
        id: 'gm_sec_6_trees',
        title: 'Section 6: Grounds Maintenance - Tree Management',
        name: 'Section 6: Grounds Maintenance - Tree Management',
        sort_order: 6,
        help_text: '',
        questions: [
          gradedQ(
