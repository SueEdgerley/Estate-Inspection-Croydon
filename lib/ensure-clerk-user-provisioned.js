 ...
 */
export async function ensureClerkUserProvisioned(clerkUserId, email = null, options = {}) {
  ...
  try {
    await run`
      INSERT INTO users (id, clerk_user_id, email, system_role, role, is_active)
      VALUES (${id}, ${clerkUserId}, ${normalized}, ${DEFAULT_APP_ROLE_FOR_NEW_USERS}, ${DEFAULT_APP_ROLE_FOR_NEW_USERS}, true)
