...
// Prefer DATABASE_URL first so Prisma + API routes point at the same DB in deployments.
...
// Keep @vercel/postgres pointed at the resolved connection string.
// This avoids Vercel env mismatches where POSTGRES_URL exists but points to a different DB.
if (connectionString && process.env.POSTGRES_URL !== connectionString) {
