 ...
 *
 * - Q1–Q21: `nv_standard` — A/B/C/D/NA + comment + photo (positions 15–16 of the former Q1–Q23 sequence are removed as duplicates of the pre–sign-off textareas; issue meta uses schema Q1–Q14 and Q17–Q23).
 ...
 * - Two synthetic `nv_plain_textarea` prompts (minor improvements; housing services comments) — **before sign-off only**.
...
/**
 * Short label from patched `_nv_key` for UI (e.g. "Q7", "Q16").
 * Issues-to-report keeps internal key Q24; residents see Q16.
...
/**
 * Maps displayed step Q1..Q21 to canonical schema keys Q1..Q14, Q17..Q23 (schema Q15/Q16 omitted on the form).
