...
const NV_EXACT_SECTIONS = [
  ...
  },
  {
    title: '25. Sign off',
    questions: [
      'Was this inspection completed on:',
      'If Paper form, please take photo and attach here',
      'Please state the date, that the resident completed this inspection?',
      'Please provide the name of the resident, that completed this inspection form, via paper?',
      'Comments',
    ],
  },
]
