...
/**
 * Caretaker: fire-safety wording + Yes-trigger where applicable.
 * Estate inspection form only: apply slot-based grading / strip extras (see `estate-standard-inspection-template-patch`).
 */
export function applyCaretakerTemplateDisplayPatches(template) {
